defmodule OrderBookWeb.UserAuthTest do
  use OrderBookWeb.ConnCase, async: true

  alias Phoenix.LiveView
  alias OrderBook.Accounts
  alias OrderBookWeb.UserAuth
  import OrderBook.AccountsFixtures
  ...
  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, OrderBookWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_user/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      OrderBookWeb.Endpoint.subscribe(live_socket_id)
