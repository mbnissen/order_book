defmodule OrderBookWeb.CoreComponents do
  @moduledoc """
  ...
  def money(assigns) do
    ~H"""
    <span>
      <%= OrderBook.Cldr.Number.to_string!(@amount, currency: @currency) %>
    </span>
    """
  end
  ...
  def translate_error({msg, opts}) do
    ...
    #   Gettext.dngettext(OrderBookWeb.Gettext, "errors", msg, msg, count, opts)
    # else
    #   Gettext.dgettext(OrderBookWeb.Gettext, "errors", msg, opts)
    # end
