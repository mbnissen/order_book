...
config :order_book, OrderBookWeb.Endpoint,
  url: [host: "localhost"],
  render_errors: [
    formats: [html: OrderBookWeb.ErrorHTML, json: OrderBookWeb.ErrorJSON],
    layout: false
  ],
  pubsub_server: OrderBook.PubSub,
  live_view: [signing_salt: "OJu3b6rG"]
...
config :order_book, OrderBook.Mailer, adapter: Swoosh.Adapters.Local
